...
//   (p => p.UseInMemoryDatabase("TareasDB"));

//builder.Services.AddSqlServer<TareasContext>("Data Source=937819W10\\SQLEXPRESS;Database=TareasDB;Integrated Security=True");
...
{
    return Results.Ok(dbContext.Categorias.Include(p => p.Tareas).Where(p => p.Peso > 30));
});
